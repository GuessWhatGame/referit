...
#
# Note that this script was copied from https://github.com/lichengunc/refer
# I am not the author of this file, and I was unable to do a simple git-link to the original file.
#
...
class REFER:
    ...
    def getRefIds(self, image_ids=[], cat_ids=[], ref_ids=[], split=''):
        ...
        if split == 'test' and self.data['dataset'] == "refcocog" and self.data['splitBy'] == "google":
            split = 'val'
    ...
    def loadAnns(self, ann_ids=[]):
        ...
        elif type(ann_ids) == int or type(ann_ids) == type(u""):
...
if __name__ == '__main__':
    data_root = "/home/fstrub/Projects/guesswhat_github/referit/data"
    refer = REFER(data_root=data_root, dataset='refcocog', splitBy='google')
